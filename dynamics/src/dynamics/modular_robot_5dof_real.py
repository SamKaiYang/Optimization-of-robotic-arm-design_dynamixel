...
class modular_robot_5dof(DHRobot):
    """
    ...
    def point_Workspace_cal_Monte_Carlo(self, robot):
        ...
        for i in range(N):
            ...
            q6 = theta6[i, 0]
            self.T = robot.fkine(
                [q1 * du, q2 * du, q3 * du, q4 * du, q5 * du, 0]
            )
    ...
    def random_select_point(self):
        ...
        file_name = self.xlsx_outpath + "/task_point_5dof" +".xlsx"
        excel_file.save(file_name)
if __name__ == '__main__':    # pragma nocover

    robot = modular_robot_5dof(symbolic=False)
    print(robot)
...
'''
    ...
    for row in rows:
        ...
        # print(T_tmp[i])
        ik_q = robot.ikine_LMS(T=T_tmp[i], mask = [1,1,1,1,1,1])
        print(ik_q)
