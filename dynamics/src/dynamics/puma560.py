...
class Puma560(DHRobot):
    ...
    def __init__(self, l2, l3 , symbolic=False):
        self.l2 = l2
        self.l3 = l3
        i2, i3, m2, m3 = self.fixed_mass_inertia(self.l2, self.l3)
        if symbolic:
        ...
        L = [
            ...
            # TODO: 2 axis a=0.4318
            RevoluteDH(
                d=0, a=self.l2, alpha=zero,
                I=i2,
            ...
            # TODO: 2 axis d =  0.4318
            RevoluteDH(
                d=self.l3, a=0, alpha=pi/2,
    ...
    def fixed_mass_inertia(self, l2,l3):
        # link2 and
        I2_index =[0.13, 0.524, 0.539, 0, 0, 0]
        l2_ori = 0.4318
        I2_index_divided = [x / l2_ori* l2 for x in I2_index]
        m2_index =17.4/0.4318
        # link3 
        I3_index =[0.066, 0.086, 0.0125, 0, 0, 0]
        l3_ori = 0.4318
        I3_index_divided = [x / l3_ori* l3 for x in I3_index]
        m3_index =4.8/0.4318
        # print(type(l3))
        I2 = I2_index_divided 
        I3 = I3_index_divided 
...
if __name__ == '__main__':    # pragma nocover
    l2 = 0.4318
    l3 = 0.4318
    puma = Puma560( l2, l3, symbolic=False)
    print(puma)
    print(puma.dynamics())
